            ...
            <table class="add_tab">
                <tbody>
                        ...
                        <td>
                            <select name="cate_id">
                                ...
                                @foreach($categories as $cate)
                                    <option value="{{$cate->id}}" @if($article->cate_id == $cate->id) selected @endif>{{$cate->cate_name}}</option>
                                @endforeach
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="lg" name="art_tags" value="{{$article->art_tags}}">
                            <p>标签以英文输入的‘,’隔开</p>
                        </td>
                    </tr>
                    {{--<tr>--}}
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="sm" name="art_sort" value="{{$article->art_sort}}">
                    ...
                    <tr>
                        ...
                        <td>
                            @foreach($articleTypes::$articleTypes as $key => $type)
                                <label for="{{'is_public'.$key}}"><input @if($article->is_public == $key) checked @endif type="radio" name="is_public" id="{{'is_public'.$key}}" value="{{$key}}">{{$type}}</label>
                            @endforeach
                        </td>
                    </tr>
                    {{--<tr>--}}
