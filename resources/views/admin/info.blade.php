...
@section('content')
	...
	<div class="crumb_warp">
		...
		<i class="fa fa-home"></i> <a href="{{URL::route('index.info')}}">首页</a> &raquo; 系统信息
	</div>
	<!--面包屑导航 结束-->
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                ...
                <li>
                    <label>运行环境</label><span>{{ apache_get_version() }} {{phpversion()}}</span>
                </li>
                <li>
                ...
                <li>
                    <label>服务器域名/IP</label><span>{{$_SERVER['SERVER_NAME']}}</span><!--localhost [ 127.0.0.1 ]-->
                </li>
                <li>
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                <li>
                    <label>联系博主：</label><span><a href="#">2281336571@qq.com</a></span>
                </li>
                <li>
